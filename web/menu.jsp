...
<c:set var="unsupportedList" value=",2,3,4,5,6,7,8,9,11,12,13,15,16,17,18,19,20,21,22,"/>
            <nav>
                            ...
                            <c:forEach items="${sessionScope.User.getRolesList()}" var="role">
                                ...
                                <c:forEach items="${role.getPermissionsList()}" var="permission">
                                    ...
                                    <li class="s4">
                                        ...
                                        <a href="${permission.getPermissionCode()}">(${permission.getPermissionID()})&nbsp;${permission.getPermissionDesc()}</a>
                                        <c:if test="${fn:contains(unsupportedList, strng)}">
                                            </span>
                                        </c:if>
                                    </li>
